...
static void test_delete()
{
    ...
    bst_free(r);
    bst_free(a);
    printf("case delete red node check\n");
    ...
    bst_free(r);
    bst_free(a);
    printf("case delete block node simple check\n");
